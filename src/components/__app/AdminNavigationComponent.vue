            ...
            items: [
              {
                ...
                command: () => {
                  push({ name: AdminRouterEnum.RIFFLE_LIST, params: { category: 'C' } })
                }
              },
              {
                label: 'ammoC',
            ...
            items: [
              {
                ...
                subtext: 'subInvoice',
                command: () => {
                  push({ name: AdminRouterEnum.INVOICE_LIST, params: { category: 'C' } })
                }
              },
              {
                label: 'orders',
